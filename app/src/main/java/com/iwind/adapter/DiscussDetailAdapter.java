...
public class DiscussDetailAdapter extends BaseAdapter {
    ...
    public DiscussDetailAdapter(Context mContext, List<HashMap<String, String>> mapList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_discuss_detail, null);
